...
jq '.channel_group.groups.Application.groups."dealer-fish-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.0.5.2","port": 7003}]},"version": "0"}}' testchannel_current_config.json > testchannel_modified_anchor_config.json
